package com.ksyun.media.kmcfilter.faceunity.demo.widget;
...
import com.ksyun.media.kmcfilter.faceunity.demo.MaterialInfoItem;
import com.ksyun.media.kmcfilter.faceunity.demo.R;
...
public class RecyclerViewAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new MaterialViewHolder(view, this);
    }
    ...
    static class MaterialViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener,
        ...
        private final WeakReference<RecyclerViewAdapter> adapter;
        ...
        public MaterialViewHolder(View itemView, RecyclerViewAdapter adapter) {
            super(itemView);
            this.adapter = new WeakReference<RecyclerViewAdapter>(adapter);
        ...
        public void onClick(View v) {
            if (adapter.get() != null &&
                    null != adapter.get().onRecyclerViewListener) {
                adapter.get().onRecyclerViewListener.onItemClick(position);
            }
        }
        ...
        public boolean onLongClick(View v) {
            if(adapter.get() != null &&
                    null != adapter.get().onRecyclerViewListener){
                return adapter.get().onRecyclerViewListener.onItemLongClick(position);
            }
            return false;
        }
    }
